...
const editVariant = async (req, res) => {
    try {
        ...
        const { ram, storage, color, quantity, regularPrice, salePrice, index, productId, specId, productOffer } = req.body;
        ...
        // ✅ Validate and update fields safely
        ...
        // ✅ Fix: Convert `productOffer` to `null` if it's invalid
        if (productOffer === "0" || productOffer === 0 || productOffer === "" || productOffer === null) {
